  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-h3 text-prava-light-text-primary dark:text-prava-dark-text-primary mb-4">
          Add Muted Word
        </h2>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <MessageSquareOff className="w-10 h-10 mx-auto mb-4 text-prava-light-text-tertiary dark:text-prava-dark-text-tertiary" strokeWidth={3} />
