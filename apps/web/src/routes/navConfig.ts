...
export const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/settings/handle': { title: 'Username', subtitle: 'Search and change your Prava ID.' },
  '/settings/profile-visibility': { title: 'Profile & visibility', subtitle: 'Private account, posts, and social list visibility.' },
  '/settings/privacy': { title: 'Privacy', subtitle: 'Activity, mentions, tags, messages, and filters.' },
  '/settings/security': { title: 'Security center', subtitle: 'Protect your account and devices.' },
  '/settings/notifications': { title: 'Notifications', subtitle: 'Push, email, sounds, mentions, and quiet hours.' },
  '/settings/chats': { title: 'Chats & messages', subtitle: 'Message privacy, groups, previews, and media.' },
  '/settings/feed': { title: 'Feed & content', subtitle: 'For You ranking, recommendations, and discovery.' },
  '/settings/friends': { title: 'Friends & social graph', subtitle: 'Friend requests, suggestions, and social signals.' },
  '/settings/appearance': { title: 'Appearance', subtitle: 'Theme, density, font size, and motion.' },
  '/settings/accessibility': { title: 'Accessibility', subtitle: 'Contrast, touch targets, labels, and autoplay.' },
  '/settings/data-storage': { title: 'Data & storage', subtitle: 'Data saver, media quality, cache, and export.' },
  '/settings/ai': { title: 'AI & personalization', subtitle: 'Recommendations, smart replies, and AI controls.' },
  '/settings/creator': { title: 'Creator / professional', subtitle: 'Creator tools, badge, and public contact controls.' },
  '/settings/danger': { title: 'Danger zone', subtitle: 'Logout, deactivation, and account deletion.' },
