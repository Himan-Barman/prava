...
export default async function apiV1Service(app: FastifyInstance): Promise<void> {
  ...
  const bridges: BridgeRoute[] = [
    ...
    { method: "GET", path: "/feed/friends", legacyPath: "/api/feed/friends" },
    { method: "GET", path: "/feed/latest", legacyPath: "/api/feed/latest" },
    { method: "GET", path: "/feed/explore", legacyPath: "/api/feed/explore" },
    { method: "GET", path: "/feed/conversations", legacyPath: "/api/feed/conversations" },
    { method: "GET", path: "/feed/catch-up", legacyPath: "/api/feed/catch-up" },
    { method: "GET", path: "/feed/topics", legacyPath: "/api/feed/topics" },
    { method: "GET", path: "/feed/topics/:topic", legacyPath: (request) => `/api/feed/topic/${param(request, "topic")}` },
    { method: "POST", path: "/feed/topics/:topic/follow", legacyPath: (request) => `/api/feed/topics/${param(request, "topic")}/follow` },
    { method: "DELETE", path: "/feed/topics/:topic/follow", legacyPath: (request) => `/api/feed/topics/${param(request, "topic")}/follow` },
    { method: "POST", path: "/feed/topics/:topic/mute", legacyPath: (request) => `/api/feed/topics/${param(request, "topic")}/mute` },
    { method: "DELETE", path: "/feed/topics/:topic/mute", legacyPath: (request) => `/api/feed/topics/${param(request, "topic")}/mute` },
    { method: "POST", path: "/feed/topics/:topic/snooze", legacyPath: (request) => `/api/feed/topics/${param(request, "topic")}/snooze` },
    { method: "GET", path: "/feed/preferences", legacyPath: "/api/feed/preferences" },
    { method: "PATCH", path: "/feed/preferences", legacyPath: "/api/feed/preferences" },
    { method: "POST", path: "/feed/preferences/reset", legacyPath: "/api/feed/preferences/reset" },
    { method: "GET", path: "/feed/preferences/export", legacyPath: "/api/feed/preferences/export" },
    { method: "GET", path: "/feed/interests", legacyPath: "/api/feed/interests" },
    { method: "DELETE", path: "/feed/interests/:topic", legacyPath: (request) => `/api/feed/interests/${param(request, "topic")}` },
    { method: "POST", path: "/feed/history/clear", legacyPath: "/api/feed/history/clear" },
    { method: "GET", path: "/feed/custom-feeds", legacyPath: "/api/feed/custom-feeds" },
    { method: "POST", path: "/feed/custom-feeds", legacyPath: "/api/feed/custom-feeds" },
    { method: "PATCH", path: "/feed/custom-feeds/:feedId", legacyPath: (request) => `/api/feed/custom-feeds/${param(request, "feedId")}` },
    { method: "DELETE", path: "/feed/custom-feeds/:feedId", legacyPath: (request) => `/api/feed/custom-feeds/${param(request, "feedId")}` },
    { method: "GET", path: "/feed/custom/:feedId", legacyPath: (request) => `/api/feed/custom/${param(request, "feedId")}` },
    ...
    { method: "POST", path: "/posts/:postId/show-more", legacyPath: (request) => `/api/feed/${param(request, "postId")}/show-more` },
    { method: "POST", path: "/posts/:postId/show-fewer", legacyPath: (request) => `/api/feed/${param(request, "postId")}/show-fewer` },
    { method: "GET", path: "/posts/:postId/why", legacyPath: (request) => `/api/feed/${param(request, "postId")}/why` },
    ...
    { method: "GET", path: "/conversations/settings", legacyPath: "/api/conversations/settings" },
    { method: "PATCH", path: "/conversations/settings", legacyPath: "/api/conversations/settings" },
    { method: "POST", path: "/conversations/report", legacyPath: "/api/conversations/report" },
    ...
    { method: "DELETE", path: "/conversations/:conversationId", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}` },
    { method: "POST", path: "/conversations/:conversationId/clear-local", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/clear-local` },
    { method: "PUT", path: "/conversations/:conversationId/preferences", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/preferences` },
    { method: "POST", path: "/conversations/:conversationId/archive", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/archive` },
    { method: "POST", path: "/conversations/:conversationId/unarchive", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/unarchive` },
    { method: "POST", path: "/conversations/:conversationId/pin", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/pin` },
    { method: "POST", path: "/conversations/:conversationId/unpin", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/unpin` },
    { method: "POST", path: "/conversations/:conversationId/favourite", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/favourite` },
    { method: "POST", path: "/conversations/:conversationId/unfavourite", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/unfavourite` },
    { method: "POST", path: "/conversations/:conversationId/mute", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/mute` },
    { method: "POST", path: "/conversations/:conversationId/unmute", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/unmute` },
    { method: "POST", path: "/conversations/:conversationId/mark-unread", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/mark-unread` },
    ...
    { method: "PATCH", path: "/conversations/:conversationId/messages/:messageId", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}` },
    { method: "DELETE", path: "/conversations/:conversationId/messages/:messageId", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}` },
    { method: "GET", path: "/conversations/:conversationId/messages/:messageId/details", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}/details` },
    { method: "POST", path: "/conversations/:conversationId/messages/:messageId/save", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}/save` },
    { method: "DELETE", path: "/conversations/:conversationId/messages/:messageId/save", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}/save` },
    { method: "POST", path: "/conversations/:conversationId/messages/:messageId/pin", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}/pin` },
    { method: "DELETE", path: "/conversations/:conversationId/messages/:messageId/pin", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/messages/${param(request, "messageId")}/pin` },
    ...
    { method: "POST", path: "/conversations/:conversationId/delivery", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/delivery` },
    { method: "GET", path: "/conversations/:conversationId/search", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/search`, query: queryParams },
    { method: "GET", path: "/conversations/:conversationId/pinned-messages", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/pinned-messages` },
    { method: "GET", path: "/conversations/:conversationId/saved-messages", legacyPath: (request) => `/api/conversations/${param(request, "conversationId")}/saved-messages` },
    ...
    { method: "GET", path: "/notifications/unread-count", legacyPath: "/api/notifications/unread-count" },
    { method: "GET", path: "/notifications/preferences", legacyPath: "/api/notifications/preferences" },
    { method: "PATCH", path: "/notifications/preferences", legacyPath: "/api/notifications/preferences" },
    { method: "POST", path: "/notifications/devices", legacyPath: "/api/notifications/devices" },
    { method: "DELETE", path: "/notifications/devices/:deviceId", legacyPath: (request) => `/api/notifications/devices/${param(request, "deviceId")}` },
    ...
    { method: "POST", path: "/notifications/:notificationId/click", legacyPath: (request) => `/api/notifications/${param(request, "notificationId")}/click` },
    { method: "DELETE", path: "/notifications/:notificationId", legacyPath: (request) => `/api/notifications/${param(request, "notificationId")}` },
