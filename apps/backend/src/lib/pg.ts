...
export async function runMigrations(p: pg.Pool): Promise<void> {
  await p.query(`
    ...
    ALTER TABLE posts ADD COLUMN IF NOT EXISTS reply_policy TEXT NOT NULL DEFAULT 'everyone';
    ALTER TABLE posts ADD COLUMN IF NOT EXISTS repost_policy TEXT NOT NULL DEFAULT 'everyone';
    ALTER TABLE posts ADD COLUMN IF NOT EXISTS like_count_visibility TEXT NOT NULL DEFAULT 'everyone';
    ALTER TABLE posts ADD COLUMN IF NOT EXISTS custom_audience_ids JSONB NOT NULL DEFAULT '[]';
